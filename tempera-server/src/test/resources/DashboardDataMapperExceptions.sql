...
INSERT INTO groupx (id, active, group_lead_username, description, name) VALUES (-1, true, 'manager', 'this is just for testing', 'testGroup1');
INSERT INTO groupx (id, active, group_lead_username, description, name) VALUES (-2, true, 'manager', 'this is also just for testing', 'testGroup2');
INSERT INTO groupx (id, active, group_lead_username, description, name) VALUES (-3, true, 'manager', 'this is also just for testing', 'outsiderGroup');
INSERT INTO groupx (id, active, group_lead_username, description, name) VALUES (-4, true, 'manager', 'this is also just for testing', 'outsiderGroup2');
...
INSERT INTO groupx_project_object (is_active, group_id, project_id)
Values (true, -2, -7), (true, -2, -8), (true, -2, -9), (true, -2, -10), (true, -2, -11), (true, -2, -12);

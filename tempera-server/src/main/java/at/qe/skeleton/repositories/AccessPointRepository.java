...
public interface AccessPointRepository extends AbstractRepository<AccessPoint, UUID>{
    ...
    /**
     * Finds the first AccessPoint that contains the specified TemperaStation. There should also be maximum
     * one AccessPoint that contains the specified TemperaStation.
     *

...
export * from './climateDataController.service';
import { ClimateDataControllerService } from './climateDataController.service';
...
export * from './tipController.service';
import { TipControllerService } from './tipController.service';
export * from './userManagementController.service';
import { UserManagementControllerService } from './userManagementController.service';
export const APIS = [AccessPointControllerService, AccumulatedTimeControllerService, AlertControllerService, AuditLogControllerService, AuthControllerService, ClimateDataControllerService, DashboardControllerService, GroupManagementControllerService, MeasurementControllerService, PeripheryConnectionControllerService, ProjectControllerService, RoomControllerService, TemperaStationControllerService, TimeRecordControllerService, TimetableControllerService, TipControllerService, UserManagementControllerService];

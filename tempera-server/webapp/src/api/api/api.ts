...
export const APIS = [AccessPointControllerService, AccumulatedTimeControllerService, AlertControllerService, AuditLogControllerService, AuthControllerService, DashboardControllerService, GroupManagementControllerService, MeasurementControllerService, PeripheryConnectionControllerService, ProjectControllerService, RoomControllerService, TemperaStationControllerService, TimeRecordControllerService, TimetableControllerService, TipControllerService, UserManagementControllerService];

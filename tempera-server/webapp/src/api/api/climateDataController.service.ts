...
export class ClimateDataControllerService {
    ...
    public getMeasurementsBySensorType(accessPointUuid: string, temperaId: string, sensorType: 'TEMPERATURE' | 'IRRADIANCE' | 'HUMIDITY' | 'NMVOC', startDateTime: string, endDateTime: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (startDateTime === null || startDateTime === undefined) {
            throw new Error('Required parameter startDateTime was null or undefined when calling getMeasurementsBySensorType.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getTemperaStations(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<TemperaStationDto>>;
    public getTemperaStations(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<TemperaStationDto>>>;
    public getTemperaStations(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<TemperaStationDto>>>;
    public getTemperaStations(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/climate_data/measurements/tempera-stations`;

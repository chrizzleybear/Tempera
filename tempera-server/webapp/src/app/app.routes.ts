    ...
    path: '', component: AppLayoutComponent, children: [
      {
        path: '', canActivate: [isLoggedInGuard], children: [
          ...
          { path: 'groups', component: GroupsComponent, canActivate: [hasAnyOfPermissionsGuard([RolesEnum.Grouplead, RolesEnum.Manager])] },
          ...
          { path: 'project/groups/:id', component: ProjectGroupsComponent, canActivate: [hasAnyOfPermissionsGuard([RolesEnum.Manager, RolesEnum.Grouplead])] },
